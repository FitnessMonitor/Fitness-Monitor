...
#define nRF24L01_CE_hi      PORTB |=  (1<<CE);
#define nRF24L01_CE_lo      PORTB &= ~(1<<CE);
...
extern void nRF24L01_read_register(uint8_t reg, uint8_t * value, uint8_t len);
extern void nRF24L01_write_register(uint8_t reg, uint8_t * value, uint8_t len);
